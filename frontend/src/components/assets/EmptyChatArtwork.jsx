...
export default function EmptyChatArtwork({ compact = false }) {
  return (
    <svg
      ...
      focusable="false"
    >
      <rect x="68" y="54" width="284" height="166" rx="18" fill="#0b1220" stroke="#26364a" />
      <path d="M68 96h284" stroke="#26364a" />
      <rect x="93" y="120" width="122" height="34" rx="11" fill="#162033" />
      <path d="M112 138h76" stroke="#64748b" strokeWidth="6" strokeLinecap="round" />
      <rect x="205" y="170" width="120" height="34" rx="11" fill="#67e8f9" />
      <path d="M225 188h65" stroke="#0f172a" strokeWidth="6" strokeLinecap="round" />
      <rect x="96" y="170" width="84" height="34" rx="11" fill="#162033" />
      ...
      <g className="animate-float-soft">
        <rect x="256" y="24" width="78" height="44" rx="12" fill="#101827" stroke="#2b3a50" />
      ...
      <g className="animate-float-soft [animation-delay:1s]">
        <rect x="42" y="205" width="90" height="48" rx="12" fill="#101827" stroke="#2b3a50" />
        <path d="M62 227h46M62 240h27" stroke="#67e8f9" strokeWidth="5" strokeLinecap="round" />
      </g>
      <foreignObject x="179" y="220" width="62" height="62">
        <div className="h-full w-full rounded-lg border border-white/10 bg-slate-950/90 p-2">
