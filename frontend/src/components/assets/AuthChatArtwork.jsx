...
export default function AuthChatArtwork({ variant = "cyan" }) {
  ...
  const primary = isWarm ? "#fbbf24" : "#818cf8";
  const secondary = isWarm ? "#fb7185" : "#34d399";
  const tertiary = isWarm ? "#a78bfa" : "#fbbf24";
  ...
  return (
    <div className="relative mx-auto w-full max-w-[560px]">
      <svg
        viewBox="0 0 720 520"
        fill="none"
        className="h-auto w-full drop-shadow-[0_38px_80px_rgba(0,0,0,0.5)]"
        aria-hidden="true"
        focusable="false"
      >
        <rect x="88" y="74" width="476" height="328" rx="18" fill="#050914" />
        <rect x="88" y="74" width="476" height="328" rx="18" stroke="#1e293b" strokeWidth="1.5" />
        <path d="M88 120h476" stroke="#1e293b" strokeWidth="1.5" />
        <circle cx="118" cy="97" r="7" fill="#fb7185" />
        <circle cx="142" cy="97" r="7" fill="#fbbf24" />
        <circle cx="166" cy="97" r="7" fill="#34d399" />

        <rect x="122" y="151" width="130" height="214" rx="12" fill="#0f1629" />
        <rect x="143" y="180" width="74" height="8" rx="4" fill="#334155" />
        <rect x="143" y="203" width="86" height="8" rx="4" fill="#1e293b" />
        <rect x="143" y="226" width="61" height="8" rx="4" fill="#1e293b" />
        <rect x="143" y="283" width="78" height="8" rx="4" fill="#334155" />
        <rect x="143" y="306" width="62" height="8" rx="4" fill="#1e293b" />
        <path d="M122 260h130" stroke="#1e293b" strokeWidth="1.5" />
        ...
        <rect x="288" y="230" width="164" height="54" rx="14" fill="#1e293b" />
        ...
        <rect x="498" y="232" width="122" height="222" rx="22" fill="#030712" />
        <rect x="511" y="250" width="96" height="166" rx="14" fill="#0f1629" />
        ...
        <g className="animate-float-soft">
          <rect x="52" y="174" width="92" height="52" rx="14" fill="#0f1629" stroke="#1e293b" />
        ...
        <g className="animate-float-soft [animation-delay:1.2s]">
          <rect x="560" y="112" width="112" height="62" rx="16" fill="#0f1629" stroke="#1e293b" />
          <path d="M586 138h56M586 154h35" stroke={tertiary} strokeWidth="7" strokeLinecap="round" />
        </g>
      </svg>

      <div className="absolute left-8 top-8 h-14 w-14 rounded-2xl border border-white/10 bg-slate-950/80 p-2 shadow-panel backdrop-blur">
