import { ArrowLeft, Check, LogOut, Mail, Save, UserRound } from "lucide-react";
        ...
        <div className="grid gap-4 lg:grid-cols-[0.85fr_1.15fr]">
          ...
          <section className="rounded-lg border border-black/25 bg-[#17212b] p-5 shadow-panel">
            <div className="flex flex-col justify-between gap-4 border-b border-black/25 pb-6 sm:flex-row sm:items-center">
              ...
              {saved ? <StatusPill tone="emerald">Saved</StatusPill> : <StatusPill>Draft</StatusPill>}
            </div>
            ...
            <form onSubmit={handleSubmit} className="mt-6 space-y-5">
                ...
                <div className="flex flex-col gap-3 pt-2 sm:flex-row">
                  <button
                    type="submit"
                    className="flex flex-1 items-center justify-center gap-2 rounded-lg bg-[#2aabee] px-5 py-3 font-semibold text-white shadow-[0_8px_22px_rgba(42,171,238,0.22)] transition hover:bg-[#37b7f4]"
                  >
                    <Save size={18} />
                    Save changes
                  </button>
...
function ProfileField({ icon: Icon, value, onChange }) {
  return (
